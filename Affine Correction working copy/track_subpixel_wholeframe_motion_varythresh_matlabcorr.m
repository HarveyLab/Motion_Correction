function [xshifts, yshifts, correlation_thresholds] = ...
    track_subpixel_wholeframe_motion_varythresh_matlabcorr(...
...
%         temp_frame=reshape(movref(1-yshift+maxshift:y-yshift-maxshift,1-xshift+maxshift:x-xshift-maxshift,:), [], z);

        corrmat(yshift+maxshift+1,xshift+maxshift+1,:) = ...
            corr(reshape(movref(1-yshift+maxshift:y-yshift-maxshift,1-xshift+maxshift:x-xshift-maxshift,:), [], z), temp_refframe);
    end
end
