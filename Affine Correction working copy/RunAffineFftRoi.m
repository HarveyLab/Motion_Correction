...
nSegments = 50; %Can only be 9, 6 or 4 at this point, but simple to modify code to allow more
...
for j=1:num_files
    ...
    if j==1
        refImg = TrackROIsMJLM(fullfilename,movie_file,nSegments,segSize);
    else
        TrackROIsMJLM(fullfilename,movie_file,nSegments,segSize,refImg);
    end
end
...
Affine_Transform_Frames(apply_filenames,movie_file, 'translation');
transformTime = toc,
%% Calculate PCs
